...
def quote(request):
    """
    View to display one random quote and one random image.
    This view handles requests to the main page (/) and /quote.
    """

    # Randomly select a quote and an image from the predefined lists.
...
def show_all(request):
    """
    View to display all quotes and all images.
    This view handles requests to /show_all.
    """
    # Pass the list of quotes and images as context data to the template.
    context = {
        "quotes": quotes,
        "images": images,
        "current_time": time.ctime(),
